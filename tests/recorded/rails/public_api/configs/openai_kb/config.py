...
# The KB uses the ``default`` (OpenAI) embedding provider so chunk retrieval is a
# recorded HTTP call; dialog intent matching uses this in-memory ``simple`` provider
# so it stays offline during replay.
